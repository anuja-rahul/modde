  ...
  return (
    <main className="flex h-auto min-h-screen w-screen flex-col flex-wrap items-center justify-center bg-transparent">
      <div className="main-grid flex h-[140vh] w-[90%] flex-row flex-wrap items-center justify-between gap-4 sm:h-[70vh] sm:flex-col">
        <div className="upload-box min-h-[70vh] w-full text-balance rounded-2xl text-primary sm:my-4 sm:w-2/5 mr-4 sm:mr-0">
          <div className="upload-content flex h-[70vh] sm:h-full w-full flex-col items-center justify-center text-balance text-center">
        ...
        <div className="static-carousel flex min-h-[70vh] w-full flex-row flex-nowrap items-center justify-normal text-balance rounded-2xl bg-slate-800/30 text-center sm:my-4 sm:w-3/5">
          <div>Photos</div>
          <div>Photos</div>
          <div>Photos</div>
        </div>
